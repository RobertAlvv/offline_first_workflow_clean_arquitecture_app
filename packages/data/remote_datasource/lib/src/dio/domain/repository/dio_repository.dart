...
import 'package:remote_datasource/src/dio/data/datasources/dio_datasource.dart';
...
class DioRepository {
  static DioRepository _instance({required DioDatasource package}) =>
      DioRepository._(client: package);

  factory DioRepository({required DioDatasource package}) =>
      _instance(package: package);

  DioRepository._({required DioDatasource client}) : _client = client;
